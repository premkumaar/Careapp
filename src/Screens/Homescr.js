...
class homescr extends Component {
 ...
 // Binding function with this class.
  ...
  handlemap = () => {
    Linking.openURL("https://www.google.com/maps/@28.5786112,77.0419205,15z").catch(err => console.error('An error occurred', err));
...
render() 
{
 ...
 <TouchableOpacity 
 activeOpacity = { .5 } onPress={ ()=>this.props.navigation.navigate('Second') }>
...
<ListView
   ...
   <TouchableOpacity
             onPress={this.GoToEditActivity.bind(this,  rowData.first_name,
       ...
       <TouchableOpacity onPress={this.GetClickedItem.bind(this, rowData.first_name,rowData.mobile_number,rowData.email_id,rowData.address)}>
